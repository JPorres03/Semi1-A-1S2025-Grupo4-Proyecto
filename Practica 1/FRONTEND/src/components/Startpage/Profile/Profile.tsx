...
function Profile() {
    ...
    // Función para solicitar la contraseña usando SweetAlert2
    const confirmActionWithPassword = async (action: () => void) => {
        ...
        if (password === "12345") {
            action(); // Ejecutar la acción si la contraseña es correcta
        } else if (password) {
            Swal.fire({
                icon: "error",
                title: "Error",
            ...
            <div className="profileContainer px-4">
                ...
                {editFoto && (
                    <div>
                        ...
                        />
                        <button className="btn btn-primary mt-2" onClick={() => confirmActionWithPassword(handleUpdateImage)}>
                            Guardar imagen
                        </button>
                    </div>
                )}
